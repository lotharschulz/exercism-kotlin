...
class ResistorColorTrioTest {
    ...
    fun `orange orange black`(){
        assertEquals("33 ohms", ResistorColorTrio.text1(ORANGE, ORANGE, BLACK))
    ...
    @Test
    fun `blue grey brown`() {
        assertEquals("680 ohms", ResistorColorTrio.text1(BLUE, GREY, BROWN))
    ...
    @Test
    fun `red black red`() {
        assertEquals("2 kiloohms", ResistorColorTrio.text1(RED, BLACK, RED))
    ...
    fun `green brown orange`() {
        assertEquals("51 kiloohms", ResistorColorTrio.text1(GREEN, BROWN, ORANGE))
    ...
    fun `yellow violet yellow`() {
        assertEquals("470 kiloohms", ResistorColorTrio.text1(YELLOW, VIOLET, YELLOW))
    ...
    fun `yellow violet violet`() {
        assertEquals("470 megaohms", ResistorColorTrio.text1(YELLOW, VIOLET, VIOLET))
